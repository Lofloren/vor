...
function Privacy() {
  ...
  <p>Our games link to external services that are not operated by us. Please be aware that I have no control over the content and practices of these services, and cannot accept responsibility or liability for their respective privacy policies.</p>
  <p> </p>
  ...
  <p/>
  <p>This application collects general usage data using Third-party Analytics services. For example, this allows us to know things like the amount of users we have and what types of devices they use. The privacy policies of the Analytics services used are linked below.</p>
  <p/>
  <p><a href='https://unity3d.com/legal/privacy-policy' style={{textDecoration: 'none'}}> Unity Privacy Policy </a> </p>
  <p/>
  <p>You are free to refuse our request for your personal information, or to examine or have destroyed any information collected on you, with the understanding that I may be unable to provide you with some of your desired services.</p>
  <p>Your continued use of our games will be regarded as acceptance of our practices around privacy and personal information. If you have any questions about how we handle user data and personal information, feel free to contact me at: </p>
